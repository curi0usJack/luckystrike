...
-- INFECTIONTYPE    9: Encrypted Executable ##TO-DO!
...
INSERT INTO PayloadTypes (Name, Description) VALUES ('Executable', 'Embeds an EXE into cells & fires');                                 --3
...
INSERT INTO InfectionTypes (Name, Description, DocType) VALUES ('Metadata', 'Saves your shell command to the `Subject` field of the metadata. Good for empire stagers!', 'xls');                                                                               --7
