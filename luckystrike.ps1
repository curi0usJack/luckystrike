...
$can_obfuscate = $true
$exitnum = "99"
$githubver = "https://raw.githubusercontent.com/curi0usJack/luckystrike/dev/currentversion.txt"
$updatefile = "https://raw.githubusercontent.com/curi0usJack/luckystrike/dev/update.ps1"
$doctype = $null
