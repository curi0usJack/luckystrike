...
if (!(Test-Path -Path $dbpath))
{
    ...
    $init = (New-Object System.Net.WebClient).Downloadstring('https://raw.githubusercontent.com/curi0usJack/luckystrike/dev/db.sql')
...
(New-Object System.Net.Webclient).DownloadFile('https://raw.githubusercontent.com/curi0usJack/luckystrike/dev/luckystrike.ps1', "$installfolder\luckystrike.ps1")
