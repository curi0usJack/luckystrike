...
$can_obfuscate = $true
$exitnum = "99"
$githubver = "https://raw.githubusercontent.com/Shellntel/luckystrike/dev/currentversion.txt"
$updatefile = "https://raw.githubusercontent.com/Shellntel/luckystrike/dev/update.ps1"
$doctype = $null
